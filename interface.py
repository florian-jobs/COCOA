...
def run_cocoa_experiment(
    ...
    if owns_conn:
        # No memory_limit means DuckDB grows unbounded until the OS OOM-kills it on base tables with
        # many distinct join values; capping it makes DuckDB spill to temp_directory instead.
